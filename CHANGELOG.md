...
Release notes for v2.1+ are generated by [release-please](https://github.com/googleapis/release-please) when you merge a Release PR. The **2.0.0** entry below was added manually (v2 shipped before the release pipeline). See [VERSIONING.md](./VERSIONING.md).

## [2.4.0](https://github.com/binodnepali/react-nepali-datetime-picker/compare/react-nepali-datetime-picker-v2.3.0...react-nepali-datetime-picker-v2.4.0) (2026-07-21)


### Features

* add compact date picker pattern and enhance date picker components ([#35](https://github.com/binodnepali/react-nepali-datetime-picker/issues/35)) ([441df87](https://github.com/binodnepali/react-nepali-datetime-picker/commit/441df871e9d793015568cad7da28286bdfbc7e83))

## [2.3.0](https://github.com/binodnepali/react-nepali-datetime-picker/compare/react-nepali-datetime-picker-v2.2.0...react-nepali-datetime-picker-v2.3.0) (2026-07-12)


### Features

* enhance picker registry with popover, Select time UI, and Safari grid fix ([8b47df0](https://github.com/binodnepali/react-nepali-datetime-picker/commit/8b47df0ebc401b0011964f1fbd7b9ea05bb506b5))

## [2.2.0](https://github.com/binodnepali/react-nepali-datetime-picker/compare/react-nepali-datetime-picker-v2.1.0...react-nepali-datetime-picker-v2.2.0) (2026-07-11)


### Features

* enhance wheel picker layout, haptics, and calendar UI ([99fcfba](https://github.com/binodnepali/react-nepali-datetime-picker/commit/99fcfbad728f1df7405d05de403462ac4f969f4d))

## [2.1.0](https://github.com/binodnepali/react-nepali-datetime-picker/compare/v1.0.2...react-nepali-datetime-picker-v2.1.0) (2026-07-09)

### Features

* `formatPattern` and `formatValue` on `BsDatePicker`, `BsTimePicker`, and `BsDateTimePicker` (date-fns-style BS tokens)
* `formatBsDateLongWithWeekday` and updated default datetime label (`Friday, 26 Ashad 2083, 10:51 PM`)

### Continuous Integration

* release-please Release PR workflow, `release:check` gate, and ESLint flat config

## [2.0.0](https://github.com/binodnepali/react-nepali-datetime-picker/compare/v1.0.2...41293c8) (2026-07-09)

> Shipped on `main` before automated releases. No `v2.0.0` git tag; this section documents the registry-first rewrite.

### ⚠ BREAKING CHANGES

* v1 npm package replaced by **shadcn registry** install (copied into your app, not `npm install`)
* `BsDate` shape: `{ year, month, day }` with **1-indexed** `month` (replaces v1 `NepaliDate` object)
* Dropped `nepali-datetime` runtime dependency and hand-maintained `monthsData`; calendar data from **Hamro Patro**

### Features

* Registry-first Bikram Sambat calendar for **web** and **React Native / Expo**
* `BsDayPicker` headless core, `BsCalendar`, `BsDatePicker`
* `BsTimePicker` and `BsDateTimePicker` (iOS wheels, Android Material dialogs, web popovers)
* BS ↔ AD helpers (`toAdDate`, `mergeBsDateTime`, etc.)
* Hamro Patro data pipeline (`data:scrape`, `data:build`, `data:validate`)

### Bug Fixes

* `BsWheelColumn` scroll out-of-bounds on native wheels
* Null-safe date parsing in formatters and navigation

### Documentation

* API docs (overview, day-picker, pickers), migration guide from v1 npm, React Native install guide
